...
- (void)testSimplePropertyWithoutContainment; {
    ...
    XCTAssertEqual(propertySetter.generatedCode, @"[[UIToolbar appearance] setTintColor:[UIColor whiteColor]];", @"");
...
- (void)testSimplePropertyWithContainment; {
    ...
    XCTAssertEqual(propertySetter.generatedCode, @"[[UIToolbar appearanceWhenContainedIn:[UIPopoverController class], nil] setTintColor:[UIColor whiteColor]];", @"");
}
...
- (void)testSimplePropertyWithDeepContainment; {
    ...
    XCTAssertEqual(propertySetter.generatedCode, @"[[UIToolbar appearanceWhenContainedIn:[UIView class], [UIPopoverController class], nil] setTintColor:[UIColor whiteColor]];", @"");
}
...
- (void)testPropertyWithAxisParameter; {
    ...
    XCTAssertEqual(propertySetter.generatedCode, @"[[UIBarButtonItem appearance] setTitlePositionAdjustment:UIOffsetMake(10.0, 10.0) forBarMetrics:UIBarMetricsDefault];", @"");
}
